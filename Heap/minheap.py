class MinHeap:
    ...
    def insert(self, item: any):
        ...
        ------------
                    ...
                    # Note: type of items must be the same in min heap.
    ...
    def _sift_up(self):
        ...
        if it is smaller than it's parent it swaps it and continues comparing until the parent's item is smaller.
        returns None
        """
    ...
    def _sift_down(self):
        ...
        the leaf or node's item is smaller than it's children.
        return None
        """
        index = 0
        ...
        try:
            while self._items[index] > self._items[left_child] or self._items[index] > self._items[right_child]:
                if right_child >= self._count or self._items[left_child] <= self._items[right_child]:
                    # if right child doesnt exist or it exists but it's value is smaller than it's left sibling
